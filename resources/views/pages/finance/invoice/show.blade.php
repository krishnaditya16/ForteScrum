    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="invoice">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <address>
                                        ...
                                        <p><strong>{{ date('D, d M Y', strtotime($invoice->issued)) }}</strong></p>
                                    </address>
                                </div>
                                <div class="col-md-6">
                                    <address>
                                        <h1 class="text-muted mb-2">DUE DATE</h1>
                                        <p><strong>{{ date('D, d M Y', strtotime($invoice->deadline)) }}</strong></p>
                                    </address>
                                </div>
                            </div>
                ...
                @if(Auth::user()->hasTeamRole($team, 'product-owner') && !Auth::user()->ownsTeam($team))
                <div class="text-md-right">
                    ...
                    <button class="btn btn-warning btn-icon icon-left" onclick="printContent('invoice-print')"><i class="fas fa-print"></i> Print</button>
                </div>
                @else
                <div class="text-md-right">
                    <button class="btn btn-warning btn-icon icon-left" onclick="printContent('invoice-print')"><i class="fas fa-print"></i> Print</button>
