...
<div class="dropdown">
    ...
    <div class="dropdown-menu">
        <a href="/project/{{ $project->id }}/reports" class="dropdown-item has-icon"><i class="fas fa-file-alt"></i> Sprints Report</a>
        <a href="/project/{{ $project->id }}/" class="dropdown-item has-icon"><i class="fas fa-clock"></i> Timesheets Report</a>
    </div>
</div>
