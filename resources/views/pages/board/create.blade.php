<x-app-layout>
    <x-slot name="title">{{ __('Create Board') }}</x-slot>
    ...
    <p class="section-lead mb-3">
        On this page you can create a new board and fill in all fields.
    </p>
            ...
            <div class="card">
                <div class="card-header">
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item mr-2">
                            <a class="nav-link active" href="{{ route('board.create') }}"><i class="fas fa-plus"></i> New Board</a>
                        </li>
                        <li class="nav-item mr-2">
