<x-app-layout>
    ...
    @if(Auth::user()->hasTeamRole($team, 'project-manager') || Auth::user()->hasTeamRole($team, 'product-owner') || Auth::user()->hasTeamRole($team, 'team-member') || Auth::user()->ownsTeam($team))
            ...
            <div class="card" style="max-height: 300px; overflow:auto">
                ...
                @foreach($projects as $project)
                    <div class="mb-4">
                        ...
                        <div class="font-weight-bold mb-1">{{ $project->title }}</div>
                        <div class="progress" data-height="8" data-toggle="tooltip" title="{{ $project->progress }}%">
                    ...
                    <div class="row pb-2">
                        ...
                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mt-2 mb-md-0">
                            <div class="avatar-item mb-0">
                                <img alt="image" src="{{ $user->profile_photo_url }}" class="img-fluid" data-toggle="tooltip" title="" data-original-title="{{ $user->name }}" style="height:112.4px">
                                <div class="avatar-badge" title="" data-toggle="tooltip" data-original-title="Project Manager"><i class="fas fa-wrench"></i></div>
                            </div>
                        </div>
                        @elseif($user->hasTeamRole($team, 'product-owner'))
                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mt-2 mb-md-0">
                            <div class="avatar-item mb-0">
                                <img alt="image" src="{{ $user->profile_photo_url }}" class="img-fluid" data-toggle="tooltip" title="" data-original-title="{{ $user->name }}" style="height:112.4px">
                                <div class="avatar-badge" title="" data-toggle="tooltip" data-original-title="Product Owner"><i class="fas fa-crown"></i></div>
                            </div>
                        </div>
